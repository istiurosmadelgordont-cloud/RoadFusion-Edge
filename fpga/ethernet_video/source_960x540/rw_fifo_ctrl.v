...
input wire     [15 : 0]            wfifo_wr_data_in      /* synthesis PAP_MARK_DEBUG="1" */,//wfifo输入数据,16bits
...
output wire    [15 : 0]            rfifo_rd_data_out     /* synthesis PAP_MARK_DEBUG="1" */,//rfifo输入数据,16bits
...
write_ddr_fifo user_write_ddr_fifo (
  ...
  .wr_data           (wfifo_wr_data_in    ),// input [15:0]  
  .wr_full           (                    ),// output        
...
read_ddr_fifo user_read_ddr_fifo (
  ...
  .rd_data           (rfifo_rd_data_out   ),// output [15:0]
  .rd_empty          (                    ),// output       
