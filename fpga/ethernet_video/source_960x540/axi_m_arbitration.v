        ...
        case(arbitration_rd_state)
            ...
            begin
                if(fram0_done) begin
                   ...
                   //    arbitration_rd_state <= READ_ARBITRATION;
                   //end  
                    if((rfifo0_wr_water_level >= ZOOM_VIDEO_LENGTH*PIXEL_WIDTH/256) && (rfifo0_state == 1)) begin
                        arbitration_rd_state <= M1_READ;    
                    end
                    else begin
                        arbitration_rd_state <= arbitration_rd_state;
            ...
            begin
                if(fram1_done) begin
                    ...
                    //    arbitration_rd_state <= READ_ARBITRATION;
                    //end  
                    if((rfifo1_wr_water_level  >= ZOOM_VIDEO_LENGTH*PIXEL_WIDTH/256)&& (rfifo1_state == 1)) begin
                        arbitration_rd_state <= READ_ARBITRATION;    
                    end
                    else begin
                        arbitration_rd_state <= arbitration_rd_state;
            ...
            begin
                if(fram2_done) begin
                    ...
                    //    arbitration_rd_state <= READ_ARBITRATION;
                    //end  
                    if((rfifo2_wr_water_level  >= ZOOM_VIDEO_LENGTH*PIXEL_WIDTH/256)&& (rfifo2_state == 1)) begin
                        arbitration_rd_state <= M3_READ;    
                    end
                    else begin
                        arbitration_rd_state <= arbitration_rd_state;
            ...
            begin
                if(fram3_done) begin
                    ...
                    //    arbitration_rd_state <= READ_ARBITRATION;
                    //end  
                    if( (rfifo3_wr_water_level  >= ZOOM_VIDEO_LENGTH*PIXEL_WIDTH/256 )&& (rfifo3_state == 1)) begin
                        arbitration_rd_state <= READ_ARBITRATION;    
                    end
                    else begin
                        arbitration_rd_state <= arbitration_rd_state;
...
rw_fifo_ctrl user_rw_fifo_ctrl0(
        ...
        .wfifo_wr_data_in     	(video0_data_in       ),//wfifo输入数据,32bits
        ...
        .rfifo_rd_data_out   	(video0_data_out)      ,//rfifo输入数据,32bits
...
rw_fifo_ctrl user_rw_fifo_ctrl1(
        ...
        .wfifo_wr_data_in 	    (video1_data_in       ),//wfifo输入数据,32bits
        ...
        .rfifo_rd_data_out	    (video1_data_out)      ,//rfifo输入数据,16bits
...
rw_fifo_ctrl user_rw_fifo_ctrl2(
        ...
        .wfifo_wr_data_in       (video2_data_in       ),//wfifo输入数据,32bits
        ...
        .rfifo_rd_data_out      (video2_data_out)      ,//rfifo输入数据,16bits
...
rw_fifo_ctrl user_rw_fifo_ctrl3(
        ...
        .wfifo_wr_data_in     	(video3_data_in        ),//wfifo输入数据,32bits
        ...
        .rfifo_rd_data_out      (video3_data_out)       ,//rfifo输入数据,32bits
